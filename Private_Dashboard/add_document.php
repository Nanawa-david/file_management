...
<!-- 
    ...
    <a href="add_file.php"><button type="button" class="btn btn-success"><i class="fas fa-plus"></i>  New Folder</button></a>
    <a href="add_file.php"><button type="button" class="btn btn-success"><i class="fas fa-upload"></i>  Upload File</button></a> 
    </div>
